...
export default function PurchasePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const fetchEvent = async () => {
      try {
        const res = await fetch("http://3.229.99.45:8080/eventos")
        const data = await res.json()

        const foundEvent = data.find((e: any) => e.id === parseInt(params.id))
        if (foundEvent) {
          setEvent(foundEvent)
          setTimeout(() => {
            setLoading(false)
  ...
  const totalPrice = event.precio * quantity
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-6">
                  <div>
                    ...
                    <Input id="name" placeholder="Juan Pérez" required className="bg-gray-50 border-gray-200 focus:bg-white text-black" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input id="card" placeholder="1234 5678 9012 3456" required className="bg-gray-50 border-gray-200 focus:bg-white text-black" />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="expiry" placeholder="MM/AA" required className="bg-gray-50 border-gray-200 focus:bg-white text-black" />
                    </div>
                    <div>
                      <Label htmlFor="cvc" className="text-gray-700">
                        CVC
                      </Label>
                      <Input id="cvc" placeholder="123" required className="bg-gray-50 border-gray-200 focus:bg-white text-black" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="mt-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="credit-card" className="text-gray-700">Tarjeta de Crédito</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <Label htmlFor="quantity" className="text-gray-700">Cantidad de Boletos</Label>
                    <Input
                      id="quantity"
                      type="number"
                      min="1"
                ...
                <Button type="submit" className="w-full mt-6 bg-purple-600 hover:bg-purple-700">Completar Compra</Button>
              </form>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="shadow-md border-0">
            ...
            <CardContent className="pt-6 bg-white">
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium text-gray-800">{event.nombre}</h3>
                ...
                <div className="border-t pt-4 border-gray-200">
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-gray-800">${event.precio.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between mb-2">
